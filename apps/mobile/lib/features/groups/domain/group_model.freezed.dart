...
class _$GroupModelImpl implements _GroupModel {
  ...
  @override
  String toString() {
    return 'GroupModel(id: $id, name: $name, description: $description, imageUrl: $imageUrl, createdBy: $createdBy, memberCount: $memberCount, inviteCode: $inviteCode, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, description, imageUrl,
      createdBy, memberCount, inviteCode, createdAt);
